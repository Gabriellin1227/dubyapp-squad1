        ...
        <div class="main-container">
            <div class="infos-container">
                <div class="infos-header">
                    <div class="infos-title">Painel de indicadores</div>
                </div>
                <div class="infos-content">
                    <div class="info-card">
                        <div class="card-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 1024 1024">
                                <path fill="#f6f6f6"
                                    ...
                                    stroke-width="25.5" stroke="#f6f6f6" />
                                <path fill="#f6f6f6"
                        ...
                        <div class="info-content">
                            <div class="info-title">Total das taxas</div>
                            <div class="data-info">R$ 600,00</div>
                        </div>
                    </div>
                    <div class="info-card">
                        <div class="card-icon">
                        ...
                        <div class="info-content">
                            <div class="info-title">Margem de lucro líquido</div>
                            <div class="data-info">85%</div>
                        </div>
                    </div>
                    <div class="info-card">
                        <div class="card-icon">
                        ...
                        <div class="info-content">
                            <div class="info-title">Taxa de conversão</div>
                            <div class="data-info">91,67%</div>
                        </div>
                    </div>
                    <div class="info-card">
                        <div class="card-icon">
                        ...
                        <div class="info-content">
                            <div class="info-title">Recebíveis em aberto</div>
                            <div class="data-info">R$ 1.000,00</div>
                        </div>
                    </div>
                    <div class="info-card">
                        <div class="card-icon">
                        ...
                        <div class="info-content">
                            <div class="info-title">Prazo médio de pagamento</div>
                            <div class="data-info">29 dias</div>
                        </div>
                    </div>
                    <div class="info-card">
                        <div class="card-icon">
                        ...
                        <div class="info-content">
                            <div class="info-title">Taxa de divergência</div>
                            <div class="data-info">4,34%</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="infos-container">
                <div class="infos-header">
                    <div class="infos-title">Análise de movimentações</div>
    ...
    .infos-container:nth-of-type(1) {
        .infos-content {
            ...
            .info-card {
                ...
                border: 1px solid rgba(18, 40, 64, 0.2);
                border-radius: 10px;
